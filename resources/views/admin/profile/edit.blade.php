        ...
        <form action="{{ route('admin.profile.update') }}" method="POST" class="space-y-5">
            ...
            <div class="space-y-1.5">
                ...
                <input type="text" name="name" id="name" value="{{ old('name', $user->name) }}" required
                    class="w-full px-4 py-2.5 bg-white border border-slate-350 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-600/25 focus:border-blue-600 transition text-sm shadow-sm font-medium"
            ...
            <div class="space-y-1.5">
                ...
                <input type="password" name="password" id="password"
                    class="w-full px-4 py-2.5 bg-white border border-slate-350 rounded-xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-600/25 focus:border-blue-600 transition text-sm shadow-sm"
            ...
            <div class="pt-4 flex justify-end gap-3">
                <a href="{{ route('admin.dashboard') }}" 
                   class="px-4 py-2.5 bg-white hover:bg-slate-100 text-slate-700 border border-slate-350 rounded-xl text-sm font-bold transition text-center shadow-sm">
                    Kembali
                </a>
                <button type="submit" 
                        class="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-sm font-bold shadow-md transition duration-150 transform active:scale-[0.98]">
                    Simpan Perubahan
                </button>
            </div>
        </form>

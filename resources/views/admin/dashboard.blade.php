...
<div class="space-y-10">
    ...
    <div class="p-6 glass-card border-slate-200/80 space-y-6">
        <div class="pb-3 border-b border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <h2 class="text-lg font-bold text-slate-900">Riwayat Seluruh Izin</h2>
            <a href="{{ route('admin.permits.export-csv', request()->query()) }}" download class="inline-flex items-center gap-1.5 px-3 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-xs font-bold transition duration-150 shadow-sm w-max">

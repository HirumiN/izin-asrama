    ...
    <div class="glass-card overflow-hidden border-slate-200/80 shadow-md">
        <div class="px-6 py-4 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-3">
                <span class="text-xs text-slate-400 font-medium">Total: {{ $stats['total'] }} mahasiswa</span>
                <a href="{{ route('admin.activities.attendance.export-csv', $activity) }}" download class="inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-xs font-bold transition duration-150 shadow-sm">

...
<div class="space-y-6 max-w-7xl mx-auto">
    ...
    <div class="flex flex-col gap-3">
        ...
        <div class="glass-card p-6 border-slate-200/80 shadow-sm">
            ...
            <!-- Statistik Ringkasan -->
            <div class="mt-5 pt-5 border-t border-slate-100 flex flex-row gap-3 overflow-x-auto">
                <div class="text-center p-3 bg-emerald-50 border border-emerald-100 rounded-xl flex-1 min-w-0">
                ...
                <div class="text-center p-3 bg-amber-50 border border-amber-100 rounded-xl flex-1 min-w-0">
                ...
                <div class="text-center p-3 bg-slate-100 border border-slate-200 rounded-xl flex-1 min-w-0">
                ...
                <div class="text-center p-3 bg-rose-50 border border-rose-100 rounded-xl flex-1 min-w-0">
                ...
                <div class="text-center p-3 bg-slate-50 border border-dashed border-slate-300 rounded-xl flex-1 min-w-0">
                    ...
                    @foreach($students as $student)
                        ...
                        <tr class="hover:bg-slate-50/30 transition">
                            ...
                            <td class="px-6 py-4">
                                @if($att)
                                    @if($att->status === 'hadir')
                                        <span class="inline-flex px-2.5 py-1 bg-emerald-50 border border-emerald-100 text-emerald-700 rounded-lg text-[11px] font-bold uppercase tracking-wider">
                                            ✓ Hadir
                                        </span>
                                    @elseif($att->status === 'sakit')
                                        <span class="inline-flex px-2.5 py-1 bg-amber-50 border border-amber-100 text-amber-700 rounded-lg text-[11px] font-bold uppercase tracking-wider">
                                            Sakit
                                        </span>
                                    @elseif($att->status === 'izin')
                                        <span class="inline-flex px-2.5 py-1 bg-slate-100 border border-slate-200 text-slate-600 rounded-lg text-[11px] font-bold uppercase tracking-wider">
                                            Izin
                                        </span>
                                    @elseif($att->status === 'alpa')
                                        <span class="inline-flex px-2.5 py-1 bg-rose-50 border border-rose-100 text-rose-700 rounded-lg text-[11px] font-bold uppercase tracking-wider">
                                            Alpa
                                        </span>
                                    @endif
                                @else
                                    <span class="inline-flex px-2.5 py-1 bg-slate-50 border border-dashed border-slate-300 text-slate-400 rounded-lg text-[11px] font-bold uppercase tracking-wider">
                                        Belum Absen
                                    </span>
                                @endif
                            </td>
                            ...
                            <td class="px-6 py-4 text-xs text-slate-400">
                                @if($att)
                                    {{ $att->updated_at->translatedFormat('d M Y, H:i') }}
                                @else

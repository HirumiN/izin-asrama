            ...
            <div class="w-full">
                ...
                <div class="relative group">
                    ...
                    <input type="text" name="search" id="search" value="{{ $search }}"
                        ...
                        class="w-full pl-11 pr-4 py-2.5 bg-white border border-slate-200 hover:border-slate-300 rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-blue-150 focus:border-blue-600 transition-all text-sm shadow-sm font-medium">
                </div>
            </div>

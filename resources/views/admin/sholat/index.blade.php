...
<div class="space-y-8 max-w-7xl mx-auto">
    ...
    <div class="glass-card p-6" id="container-admin-sholat-monitoring">
        <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6">
            ...
            <a href="{{ route('admin.sholat.export-csv', request()->query()) }}" download class="inline-flex items-center gap-1.5 px-3.5 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-bold transition duration-150 shadow-sm shrink-0">
